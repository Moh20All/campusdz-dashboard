...
const SuperAdminDashboard: React.FC = () => {
  ...
  const regionalStats = [
    { region: 'North', universities: 15, students: 180000 },
    { region: 'South', universities: 8, students: 80000 },
    { region: 'Center', universities: 12, students: 120000 },
    { region: 'West', universities: 7, students: 75000 },
    { region: 'East', universities: 3, students: 45000 }
  ];
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {regionalStats.map((region, index) => {
                      const colors = [
                        'bg-indigo-500', 'bg-purple-500', 'bg-pink-500', 'bg-amber-500', 'bg-teal-500'
                      ];
